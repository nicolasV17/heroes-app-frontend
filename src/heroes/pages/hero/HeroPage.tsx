...
import { useHeroSlug } from '@/heroes/hooks/useHeroSlug';
...
export const HeroPage = () => {
  ...
  const slug = params.idSlug;
  

  const {data:heroSlugResponse, isError} = useHeroSlug(slug || "");

  console.log(heroSlugResponse);

   const superheroData = heroSlugResponse || {
    id: "1",
    name: "Clark Kent",
    alias: "Superman",
