...
export const SearchControls = () => {
  ...
  const handleKeyDown = (event:KeyboardEvent<HTMLInputElement>) => {
    ...
    if(event.key === "Enter") {
       const valueName = inputRef.current?.value ?? "";
        setQueryParams("name",valueName);
    }
  }
  return (
            ...
            <div className="bg-white rounded-lg p-6 mb-8 shadow-sm border">
                ...
                <Accordion type="single" collapsible value={activeAccordion}>
                    <AccordionItem value="advance-filters">
                        {/* <AccordionTrigger> <h3 className="text-lg font-semibold">Advanced Filters</h3></AccordionTrigger> */}
                        <AccordionContent>
                                ...
                                <div className="mt-4">
                                    ...
                                    <Slider defaultValue={[strength]} max={10} step={1} onValueChange={(value) => setQueryParams("strength",value[0].toString())} />
                                </div>
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>
